        ...
        <Col md={6} sm={12} xs={12}>
          <div className="right-item my-2">
            ...
            <p>
              ...
              landscapes, we have offers for you.Treat yourself with a journey
              to your inner self. Visit a mystique Tibet and start your
              spiritual adventure. We promise, you’ll enjoy every step you make.
            </p>
            <button className="">See more  <i class="fas fa-arrow-right"></i></button>
          </div>
        </Col>
      </Row>
    </Container>
