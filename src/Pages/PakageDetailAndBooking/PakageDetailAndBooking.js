      ...
      <Row className="booking-from overflow-hidden">
        <Col md={6} sm={12} xs={12}>
          <div className="pakage-details my-4">
            ...
            <h2>
              ${singlePakage.price} <span>/Per Person</span>{" "}
            </h2>
            <p>{singlePakage.description}</p>
            <h5>
              <i class="far fa-star"></i> {singlePakage.rating}
            </h5>
          </div>
        </Col>
        <Col md={6} sm={12} xs={12}>
          <form className="booking-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            <input
              defaultValue={singlePakage.name}
              {...register("pakageName", { required: true })}
            />
            <input
              defaultValue={singlePakage.img}
              {...register("pakageImage", { required: true })}
            />
            <input
              defaultValue={singlePakage.price}
              {...register("pakagePrice", { required: true })}
            />
            <input
              defaultValue={singlePakage._id}
              {...register("pakageId", { required: true })}
            />
            <input
              placeholder="Phone"
              defaultValue=""
