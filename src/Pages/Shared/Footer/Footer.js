        ...
        <Row>
          <Col md={3} sm={6} xs={12}>
            <div className="about-us">
              <img src={logo} alt="" />
              <h4>
                Travelink . The Best Travel Agency Company. Trusted and reliable
                tour and travel agency among all the leading and updated tour
                operation service in Bangladesh
              </h4>
              <ul>
                <li>
          ...
          <Col md={3} sm={6} xs={12}>
            <div className="we-accept">
              ...
              <img
                className="w-100"
                src="https://i.ibb.co/PCkYDgv/ssl-commerce-1d268dce.png"
                alt=""
              />
            </div>
          </Col>
